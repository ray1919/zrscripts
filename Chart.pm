...
sub _legend {
  ...
  for ( 0 .. 2 ) {
    ...
    $image->stringFT( $this->{_conf_color}{black}, '/usr/share/fonts/truetype/msttcorefonts/Courier_New.ttf', 10, 0, $xtext, $ytext + 10, $this->{_legend}->[$_] );
...
sub _title {
  ...
  $align->font_path('/usr/share/fonts/truetype/msttcorefonts/');
  $align->set_font('Courier_New_Bold', 14);
...
sub _circle {
  ...
  $image->stringFT( $this->{_conf_color}{black}, '/usr/share/fonts/truetype/msttcorefonts/Courier_New_Bold.ttf', 14, 0,
  ...
  if ( defined $ref_data3 ) {
    ...
    $image->stringFT( $this->{_conf_color}{black}, '/usr/share/fonts/truetype/msttcorefonts/Courier_New_Bold.ttf', 14, 0,
      # $image->string( gdMediumBoldFont,
      $this->{_coords}{xt13} + 20,
      $this->{_coords}{yt13} + 30,
